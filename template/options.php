		...
		<div class="advanced-excerpt-main">
			...
			<?php if ( function_exists( 'wp_nonce_field' ) ) wp_nonce_field( 'advanced_excerpt_update_options' ); ?>
				<table class="form-table">
					...
					<tr valign="top">
						<th scope="row">
							<label for="skip-headers">
							<?php _e( "Skip Headers:", 'advanced-excerpt' ); ?>
							</label>
						</th>
						<td>
							<label for="skip-headers">
					...
					<tr valign="top">
						<th scope="row">
							<label for="max-top-level-structures">
							<?php _e( "Max Top-Level Structures:", 'advanced-excerpt' ); ?>
							</label>
						</th>
						<td>
					...
					<tr valign="top">
						<th scope="row">
							<?php _e( "Homepage Category Filter:", 'advanced-excerpt' ); ?>
						</th>
						<td>
							<p>
								<label for="enable-homepage-category-filter">
								<input name="enable_homepage_category_filter" type="checkbox" id="enable-homepage-category-filter" value="on" <?php echo ( 1 == $enable_homepage_category_filter ) ? 'checked="checked"' : ''; ?> />
								<?php _e( "Show only posts from specific categories on the homepage", 'advanced-excerpt' ); ?>
								</label>
							</p>
							<div id="homepage-categories-list" class="sub-options" <?php echo ( 1 !== $enable_homepage_category_filter ) ? 'style="display:none;"' : ''; ?>>
								<p><strong><?php _e( 'Select Categories:', 'advanced-excerpt' ); ?></strong></p>
								<?php
								...
								if ( ! empty( $categories ) ) :
									...
									echo '<p>' . __( 'No categories found.', 'advanced-excerpt' ) . '</p>';
								endif;
								?>
							</div>
							<p class="description">
